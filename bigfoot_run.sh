...
for JOB_NAME in "${JOB_NAMES[@]}"; do
    echo "nohup python3 train_deephyper.py --config config${JOB_NAME}.yaml &" >> "./run_script_OAR/auto_runoar_bigfoot_${JOB_NAME_FILE}.sh"
done
echo "wait" >> "./run_script_OAR/auto_runoar_bigfoot_${JOB_NAME_FILE}.sh"
oarsub -l /nodes=1/gpu=1,walltime=${WALLTIME}:0:0 --project pr-lawbot -p "gpumodel='V100'" /home/gauffrea/SMABalancingGroups/run_script_OAR/auto_runoar_bigfoot_${JOB_NAME_FILE}.sh